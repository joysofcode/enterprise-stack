...
Time is money and setting up a project can be a lot when you should be focused on the business logic instead. Tap into your true potential and you're going to be laughing "Ha Ha! Business" out loud in no time to the bank.
...
- [Lucide](https://lucide.dev/) for icons to look stylish
- It also configures [TypeScript](https://www.typescriptlang.org/), [Prettier](https://prettier.io/), [ESLint](https://eslint.org/) and [Playwright](https://playwright.dev/) and [Vitest](https://vitest.dev/) for testing
